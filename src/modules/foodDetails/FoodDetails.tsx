          ...
          <div className="container mb-5">
            ...
            <div className="row">
              ...
              <div>
                ...
                <button className="mx-3 btn btn-success" onClick={addItemFromCart}>Add Item</button>
                <button className="btn btn-danger" onClick={removeItemFromCart}>Remove Item</button>
